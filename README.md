...
- **18 MCP tools** — search, trace, architecture, impact analysis, targeted index-coverage checks, Cypher queries, dead code detection, cross-service HTTP linking, ADR and personal memory management, and more.
...
Restart your agent. Verify with `/mcp` — you should see `codebase-memory-mcp` with 18 tools.
